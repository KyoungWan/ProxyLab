...
void parse_line(request_line *);
void parse_header(request_header *);
...
void parseline(request_line* line)
{
  printf("enter parseline\n");
  printf("method: %s uri: %s version: %s\n", line->method, line->uri, line->version);
  //buf: GET http://www.example.com HTTP/1.0
}

void parseheader(request_header* header, char *buf)
{
  printf("enter parseheader\n");
